...
/**
 * Thrown when game state name is not uniq.
 * @author ncrashed
 */
public class GameStateConflictException extends Exception
{
    public GameStateConflictException(String gameStateName)
    {
        super("Detected name clash within game states. Problem name: "
                .concat(gameStateName));
    }
}
